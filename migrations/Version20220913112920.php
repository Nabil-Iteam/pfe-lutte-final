 ...
 */
final class Version20220913112920 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN is_valid BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN birth_day DATETIME NOT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN gender VARCHAR(255) NOT NULL');
    }
